...
This project is indexed by GitNexus as **Autonomous-AutoTrader** (701 symbols, 788 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
