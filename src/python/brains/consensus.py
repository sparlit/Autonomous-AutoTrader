...
class ConsensusEngine:
    ...
    def analyze_sync(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if not hist_data: return {"act": "WAIT", "reason": "No history"}
        ...
        # Institutional Parallel Processing
        ...
        # Sigma-Based Dynamic Proximity (Devil's Audit 1.2)
        # Instead of 0.5 * ATR, use ATR as a measure of 1-sigma volatility
